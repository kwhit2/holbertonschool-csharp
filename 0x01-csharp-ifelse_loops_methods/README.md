        Project: 0x01. C# - if/else, loops, functions
...
*   [if-else (C# Reference)](/rltoken/Nz1OIJLkLf_BXCMFpNe2hQ "if-else (C# Reference)")
*   [Control Statements - Loops](/rltoken/ayQfhoD3KpTEmqPSL0AXIA "Control Statements - Loops") (_You do not need to know `foreach` yet_)
*   [Methods (C# Reference)](/rltoken/9qH3OX8LG6jZkwpOTG3wOQ "Methods (C# Reference)") (_Read up to “Async Methods”_)
*   [Standard Numeric Format Strings](/rltoken/dGaz9qyKciFDltshmI97aA "Standard Numeric Format Strings")
*   [Iteration Statements](/rltoken/uJytHDQvkRGWZCTqgivKXA "Iteration Statements")
*   [C# Language Reference](/rltoken/tKZYs3hsvL4SvU80GGgmiw "C# Language Reference")
*   [C# Coding Conventions](/rltoken/02sq_6zjTCyNoUCBvnb3Aw "C# Coding Conventions")
...
This program will assign a random signed number to the variable `number` each time it is executed. Complete the [source code](/rltoken/D1Q7UK9CkuiPt2Eiel5m0g "source code") in order to print whether the number stored in the variable `number` is positive or negative.

*   You can find the source code [here](/rltoken/D1Q7UK9CkuiPt2Eiel5m0g "here")
...
This program will assign a random signed number to the variable `number` each time it is executed. Complete the [source code](/rltoken/4djJtB8TkEhToAtTrCkymA "source code") in order to print whether the number stored in the variable `number` is positive or negative.

*   You can find the source code [here](/rltoken/4djJtB8TkEhToAtTrCkymA "here")
*   The variable `number` will store a different value every time you will run this program
*   You don’t have to understand what `Random` does. Please do not touch this code
*   The output of the program should be:
